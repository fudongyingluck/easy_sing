...
export const PRESET_MODES = [
  { id: 'male', name: '♂ 男声模式', startNote: 'E2', endNote: 'C5', minFreq: 80, maxFreq: 520 },
  { id: 'female', name: '♀ 女声模式', startNote: 'C3', endNote: 'C6', minFreq: 160, maxFreq: 1040 },
  { id: 'guitar', name: '🎸 吉他模式', startNote: 'E2', endNote: 'E6', minFreq: 82, maxFreq: 1319 },
  { id: 'violin', name: '🎻 小提琴模式', startNote: 'G3', endNote: 'E7', minFreq: 196, maxFreq: 2637 }
] as const
